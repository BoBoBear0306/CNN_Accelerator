...
│  │  |  |  |── resnet_swish_batch_size_weight_max.txt
...
│  │  ├── optimizer.py
│  │  ├── preprocessing.py
│  │  ├── scale_batch_size_conv2d_func.py
│  │  ├── scale_factor.py
│  │  ├── sfp_quant.py
...
```python
    ...
    # pretrain_dir = '20241023_mobilenet_imgnet_1e6_batch_size_68.068.pth'    # 68.068%  
    # pretrain_dir = '20241023_mobilenet_imgnet_1e6_batch_size_68.068.pth'    # 68.068%
